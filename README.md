...
## Environments
- Preview: https://main--siva-eds-local--sivaraj2023.aem.page/
- Live: https://main--siva-eds-local--sivaraj2023.aem.live/
...
1. Open the `siva-eds-local` directory in your favourite IDE and start coding :)
